...
<head>
    ...
    .pagination_link  {
      ...
      .pagination_link a:hover:not(.active) {background-color: white;}
...
$output .= "<span class='pagination_link' style='cursor:pointer; padding:6px; border:1px solid #ccc;' id='".($page-1)."'>".$i."</span>";  
 ...
 {  
     $active = $i == $page ? 'class="active"' : '';
       ...
       $output .= "<span $active class='pagination_link' style='cursor:pointer; padding:6px; border:1px solid #ccc;' id='".$i."'>".$i."</span>"; 
